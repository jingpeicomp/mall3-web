<template>
    <div class="scroll-y">
        ...
        <el-table id="mainTable" ref="mainTable" :height="`calc(100vh - ${settings.delWindowHeight})`" border
            ...
            <!--点击操作-->
            <el-table-column fixed="right" align="center" label="操作" min-width="65">
                <template #default="{ row }">
                    <el-button link size="small" type="primary" @click="itemViewBtnClick(row)">查询卡号</el-button>
                </template>
            </el-table-column>
        </el-table>
        ...
        <StockGoodsEditForm v-if="showItemViewForm" ref="refItemViewForm" @hideComp="hideComp"
...
import StockGoodsEditForm from './SellerGoodsEditForm.vue'
